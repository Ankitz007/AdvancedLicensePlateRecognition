...
# Detect vehicles
python2 vehicle-detection.py $input_dir $output_dir

# Detect license plates
python2 license-plate-detection.py $output_dir $lp_model

# OCR
python2 license-plate-ocr.py $output_dir

# Draw output and generate list
python2 gen-outputs.py $input_dir $output_dir > $csv_file
